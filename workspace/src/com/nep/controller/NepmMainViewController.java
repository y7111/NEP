...
public class NepmMainViewController implements Initializable {
 ...
 @Override
    ...
    public void aqiInfo(){
        JavafxUtil.showStage(NepmMain.class, "view/NepmAqiInfoView.fxml", primaryStage, "东软环保公众监督平台-管理端-AQI反馈数据查询");
    }

    public void aqiAssign(){
        NepmAqiAssignViewController.aqiInfoStage = JavafxUtil.showStage(NepmMain.class, "view/NepmAqiAssignView.fxml", primaryStage, "东软环保公众监督平台-管理端-AQI反馈数据指派");;
    }

    public void aqiConfirm(){
        JavafxUtil.showStage(NepmMain.class, "view/NepmConfirmInfoView.fxml", primaryStage, "东软环保公众监督平台-管理端-AQI实测数据查询");
    }
}
