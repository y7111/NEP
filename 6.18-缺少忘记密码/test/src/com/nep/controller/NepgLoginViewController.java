...
public class NepgLoginViewController {
    ...
    public TextField getTxt_password() { return txt_password; }
    public void setTxt_password(TextField txt_password) { this.txt_password = txt_password; }
    ...
    public void login(){
        ...
        GridMember loggedInGridMember = gridMemberService.login(txt_id.getText(), txt_password.getText());

        if(loggedInGridMember != null){
            NepgAqiConfirmViewController.primaryStage = primaryStage;
            NepgAqiConfirmViewController.gridMember = loggedInGridMember;
